...
const WORD_BUILDER_EASY: WordPair[] = [
  ...
  { mother: 'MESA',     hidden: 'SEM' },
  { mother: 'PARED',    hidden: 'RED' },
  { mother: 'BOTELLA',  hidden: 'BOT' },
  { mother: 'CORONA',   hidden: 'RON' },
  { mother: 'PASTEL',   hidden: 'TEL' },
  { mother: 'JAMÓN',    hidden: 'MÁS' },
  { mother: 'RELOJ',    hidden: 'ORO' },
  { mother: 'CUADRO',   hidden: 'CRU' },
  { mother: 'DISCO',    hidden: 'SOL' },
  { mother: 'PORTAL',   hidden: 'POL' },
  { mother: 'CANCIÓN',  hidden: 'CON' },
  { mother: 'PLUMA',    hidden: 'MAL' },
  { mother: 'TEATRO',   hidden: 'TÉ' },
  { mother: 'CIUDAD',   hidden: 'DAR' },
  { mother: 'LÁMPARA',  hidden: 'MAR' },
]
...
const WORD_BUILDER_MEDIUM: WordPair[] = [
  ...
  { mother: 'GUITARRA',  hidden: 'RAÍZ' },
  { mother: 'PATINES',   hidden: 'PINO' },
  { mother: 'MANTECA',   hidden: 'MATE' },
  { mother: 'CASCADA',   hidden: 'SACA' },
  { mother: 'CORDERO',   hidden: 'CORO' },
  { mother: 'TARJETA',   hidden: 'ARTE' },
  { mother: 'SEMILLA',   hidden: 'MISA' },
  { mother: 'PALACIO',   hidden: 'PALO' },
  { mother: 'GUITARRA',  hidden: 'RUTA' },
  { mother: 'MENSAJE',   hidden: 'MANO' },
  { mother: 'BOTONES',   hidden: 'BOTE' },
  { mother: 'CAMELLO',   hidden: 'CAMA' },
  { mother: 'ESCOBA',    hidden: 'COSA' },
  { mother: 'MEDALLA',   hidden: 'MALA' },
  { mother: 'PAJARITO',  hidden: 'PATO' },
]
...
const WORD_BUILDER_HARD: WordPair[] = [
  ...
  { mother: 'DECORACION', hidden: 'RONDA'  },
  { mother: 'SALTARINES', hidden: 'TENIS'  },
  { mother: 'CARPINTERO', hidden: 'PATIO'  },
  { mother: 'BIBLIOTECA', hidden: 'TABLA'  },
  { mother: 'COSTURERA',  hidden: 'COSTA'  },
  { mother: 'MALETERO',   hidden: 'METRO'  },
  { mother: 'CAMPAMENTO', hidden: 'TOMEN'  },
  { mother: 'FOTOGRAFIA', hidden: 'FRITO'  },
  { mother: 'AEROPUERTO', hidden: 'TORRE'  },
  { mother: 'DINOSAURIO', hidden: 'RONDA'  },
  { mother: 'ESTRELLITA', hidden: 'TALLER' },
  { mother: 'TEMPORADA',  hidden: 'TOMAR'  },
  { mother: 'ELEFANTES',  hidden: 'TENSA'  },
  { mother: 'CASTILLOS',  hidden: 'SOCIAL' },
  { mother: 'NARANJAS',   hidden: 'RASAR'  },
]
